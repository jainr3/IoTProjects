// Code from https://randomnerdtutorials.com/esp32-cam-send-photos-email/
...
#define emailSenderPassword   "SenderPassword"
#define smtpServer            "smtp.gmail.com"
#define smtpServerPort        465
#define emailSubject          "ESP32-CAM Photo Captured"
#define emailRecipient        "RecipientEmail"
...
void loop() {
  ...
  if (val == HIGH) {
      ...
      sendPhoto();
      delay(20000); // prevents spamming of the pushbutton
  }
}
